...
A later direction for this project could be a simple model or agent that periodically pulls the available data sources, recomputes the friction scores, and explains what changed.
